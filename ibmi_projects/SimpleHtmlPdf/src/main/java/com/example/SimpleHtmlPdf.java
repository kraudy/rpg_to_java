        ...
        "<html>" +
          "<head>" +
            "<style>" +
              ...
              "h1 { color: navy; border-bottom: 1px solid #ccc; padding-bottom: 5px; }" +
              "table { width: 100%; border-collapse: collapse; margin-top: 20px; }" +
              "th, td { border: 1px solid #aaa; padding: 8px; text-align: left; }" +
              "th { background-color: #f0f0f0; }" +
              "footer { font-size: 10pt; text-align: center; margin-top: 50px; color: #777; }" +
            "</style>" +
          "</head>" +
            "<body>" +
            "<h1>Hello, World!</h1>" +
            ...
            "<table>" +
              ...
              "<tbody>" +
              "<tr><td>Apples</td><td>3</td><td>€2.40</td></tr>" +
              "<tr><td>Bananas</td><td>5</td><td>€3.00</td></tr>" +
              "<tr><td>Oranges</td><td>2</td><td>€1.60</td></tr>" +
              "</tbody>" +
            "</table>" +
            "<p>Also note:</p>" +
            "<ul>" +
